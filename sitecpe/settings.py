...
SECRET_KEY = 'django-insecure-n^bnzh_^en-0z#+a^)v*(6=o27kf7r)b635#@9)hig=a(&j677'
...
DATABASES = {
  'default': {
        ...
        'NAME': 'cpe_db',           # Le nom que tu as donné dans pgAdmin
        'USER': 'postgres',            # L'utilisateur par défaut de Postgres
        'PASSWORD': 'tony',            # Le mot de passe choisi à l'installation
        'HOST': '127.0.0.1',           # Ton ordinateur local
